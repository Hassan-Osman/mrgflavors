<!-- footer begin -->
    <footer style="padding: 0px;">
      <div class="subfooter">
        <div class="container">
          <div class="row">
            <div class="col-md-6"> © Copyright. mrgflavors.com. All Rights Reserved 2018 </div>
            <div class="col-md-6 text-right">
              <div class="social-icons"> 
                <a href="https://www.facebook.com/mrgflavorsofficial/" target="_new"><i class="fa fa-facebook fa-lg"></i></a> 
              </div>
            </div>
          </div>
        </div>
